...
public class ActivityHelper {
    ...
    public void addActivities() {
        ...
        activities.add( new Activity(R.drawable.milkart, R.drawable.milkart,"Milk Art", "materials:\n" +
                ...
                "Dish soaps are used on greasy or oily dishes because it breaks the bonds in fats allowing them to separate. When you add the dish soap to the milk, " +
        ...
        activities.add( new Activity(R.drawable.fish_age, R.drawable.fish_age,"Fish Age", "materials:\n" +
                ...
                "3. Find the parts of the scales that resemble clusters and count them.", "EXPLANATION:\nThe scales on a fish form within weeks after hatching." +
                " They are protection for the fish, but you can use these scales as a way of telling the age of the fish. The scales have round, bony ridges, called circuli, " +
        ...
        activities.add( new Activity(R.drawable.apple, R.drawable.applebite,"Quick Spoil", "materials:\n" +
                ...
                "EXPLANATION:\nFruit and vegetables are protected by their skins or peels. When you took a bite out of the apple, you removed the skin that was protecting the inside. " +
                "The inside was exposed to the air, and an oxidation process began. Oxidation is a chemical reaction that causes the inside of the apple to react with the oxygen and begin to decay.\n"));
        ...
        activities.add( new Activity(R.drawable.stump, R.drawable.stump,"Tree Stump", "materials:\n" +
                ...
                "EXPLANATION:\nBy counting the rings of the tree you can tell the approximate age of" +
                        " the tree when it was cut down. The rings in the early years of the tree’s life are usually wider because growth is more rapid in these years. \n"));
